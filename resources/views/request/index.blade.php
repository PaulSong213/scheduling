                    ...
                    <section id="services" class="features-icons">
                        <div class="container">
                            <div class="row">
                                ...
                                @if(sizeof($credentials) + sizeof($permits) <= 0 ) <h5 class="text-secondary">You did not create a Request yet. Request below the Service you need.</h5>
                                    @else
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="max-width: 150px; background-color: rgb(242, 247, 244)">
                                                        <div>
                                                            <span>Type: </span>
                                                            <span class="fw-bold">{{ $credential->credential_type }}</span>
                                                        </div>
                                                        <div>
                                                            <span>Purpose: </span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-capitalize  ">
                                                        <span style="width: 100px" class="{{ $status_color[$permit->status] }} fw-bold">
                                                            {{ $permit->status }}
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td style="max-width: 200px">
                                                        {{ $permit->status == 'scheduled' ? 'You can get your requested document on assigned scheduled date at Barangay Hall of Ligas 1' : $permit->decline_reason }}
                                                    </td>
                                                </tr>
                                                @endforeach
                                            <tbody>
                    ...
                    <section id="services" class="features-icons">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-3 ">
                                    <a href="{{ $service['path'] }}" class="text-black d-block service-card bg-white shadow-sm py-1 text-decoration-none border" style="border-radius: 10px">
                                        <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                                            <div class="features-icons-icon d-flex mb-3"><i class=" {{ $service['icon'] }} m-auto text-primary fs-1"></i>
                                            </div>

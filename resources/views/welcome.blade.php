            ...
            <div class="row px-3 py-1">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-8">
                                <div class="text-center text-white">
                                    <!-- Page heading-->
                                    <h1 class="mb-5">Barangay Ligas 1 <br /> Online Public Files Requesting System
                                    </h1>
                                    <!-- Signup form-->
                                    <!-- * * * * * * * * * * * * * * *-->
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="p-3 col-lg-4 ">
                                <a href="{{ $service['path'] }}" class="text-black d-block service-card bg-white shadow-sm py-5 text-decoration-none" style="border-radius: 10px">
                                    <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                                        <div class="features-icons-icon d-flex"><i class=" {{ $service['icon'] }} m-auto text-primary"></i></div>
                ...
                <section class="call-to-action text-white text-center" id="signup">
                    <div class="container position-relative">
                        <div class="row justify-content-center">
                            <div class="col-xl-6">
                                <h2 class="mb-4">Create an Account to easily access Barangay Services</h2>
                ...
                <section class="features-icons bg-light text-center pt-5">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="p-3 col-lg-6 " data-bs-toggle="modal" data-bs-target="#event{{ $event->id }}">
                                <div role="button" class="text-black d-block service-card bg-white shadow-sm py-5 text-decoration-none cursor-pointer" style="border-radius: 10px">
                                    <div class="px-4 mx-auto mb-5 mb-lg-0 mb-lg-3">
                                        <div class="event-image-container ">

                                            <img class="event-image" src="{{ $event->event_filename }}">
                                        </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <img style="width: 100%" src="{{ $event->event_filename }}">
                                            <div>
                            ...
                            <div class="w-max p-3 d-block">
                                <div class="testimonial-item mb-5 mb-lg-0">
                                    <div class="official-img-container mb-3">
                                        <img class="official-img" src="{{ str_replace("public","storage",$official->profile_filename) }}" />
                                    </div>
